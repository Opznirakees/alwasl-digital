...
| D13 | Managed multi-category catalog and expansion policy | `docs/scope-deviations.md` | WAHO and Asiacell categories are available and additional products remain controlled by admin activation. |
...
- Multi-category catalog scope, including fulfillment modes and inactive-by-default expansion controls.
...
- Public activation of additional products before fulfillment, pricing, support, translations, and QA are approved.
