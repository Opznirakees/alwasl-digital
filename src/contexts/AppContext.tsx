...
const zhTranslations: Record<string, string> = {
  ...
  'Choose coins, gifts, room boosts, games, VIP medals, or profile upgrades, then enter the WAHO details and pay securely.': '选择金币、礼物、房间提升、游戏、VIP 勋章或资料升级，然后输入 WAHO 信息并安全支付。',
  'Top up WAHO': '充值 WAHO',
  'How it works': '服务流程',
  'Fast top-up': '快速充值',
  'Clear choices for WAHO top-ups': '清晰的 WAHO 充值选择',
  'Choose': '选择',
  'Check': '确认',
  'Top up': '充值',
  ...
  'Complete order': '完成订单',
  'Top up WAHO services': '充值 WAHO 服务',
  'Pick coins, gifts, rooms, games, or VIP upgrades and top up quickly.': '选择金币、礼物、房间、游戏或 VIP 升级并快速充值。',
  'Contact us for WAHO top-ups, orders, or account help.': '联系我们获取 WAHO 充值、订单或账号帮助。',
  'Fast WAHO top-ups with digital services for promotion, recharge, and customer support.': '快速 WAHO 充值，并提供推广、充值和客户支持等数字服务。',
  'Simple steps': '简单步骤',
  'Ready for a quick WAHO top-up': '已准备好快速充值 WAHO',
  ...
  'Fast WAHO top-ups for coins, gifts, rooms, and VIP upgrades.': '为金币、礼物、房间和 VIP 升级提供快速 WAHO 充值。',
  'Al-Wasl Digital helps customers top up WAHO quickly with clear packages and local payment options.': 'Al-Wasl 数字服务帮助客户通过清晰套餐和本地支付方式快速充值 WAHO。',
  'Browse WAHO top-ups': '浏览 WAHO 充值',
  'Customers can choose WAHO coins, gift bundles, room boosts, party games, and VIP upgrades with clear pricing.': '客户可以选择 WAHO 金币、礼物套餐、房间提升、派对游戏和 VIP 升级，价格清晰。',
  'The current release shows the WAHO top-up flow from login to payment and order tracking.': '当前版本展示从登录到支付和订单跟踪的 WAHO 充值流程。',
  'Connect live payment methods.': '连接正式支付方式。',
  'Speed up order handling.': '加快订单处理。',
  ...
  'Orders are simulated in the demo. Live orders will move through pending, processing, completed, failed, or refunded states.': '演示中订单为模拟。正式订单会经历待处理、处理中、已完成、失败或已退款等状态。',
